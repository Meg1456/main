...
- Grades can be in the form of numbers of letters. No restriction! It is up to the teacher to decide.
...
- Restriction of v1.3: The grades can only be 'int' values, not 'float'
