...
public class StorageFile extends Storage {
    ...
    public StorageFile() throws InvalidStorageFilePathException,
        ...
        this(DEFAULT_STORAGE_FILEPATH, DEFAULT_STATISTICS_FILEPATH);
    }
    public StorageFile(String filePath) throws InvalidStorageFilePathException, InvalidInitialisationException {
        this(filePath, DEFAULT_STATISTICS_FILEPATH);
    }
    /**
     * @throws InvalidStorageFilePathException if the given file path is invalid
     */
    public StorageFile(String filePath, String filePathStatistics)
            throws InvalidStorageFilePathException,
            InvalidInitialisationException {
        try {
            jaxbContext = JAXBContext.newInstance(AdaptedAddressBook.class);
            jaxbContext2 = JAXBContext.newInstance(AdaptedStatisticsBook.class);
